...
NON_MMA_FAMILIES = {
    ...
    'qkv_pack_e4': 'stage_qkv_pack_e4_from_fp16',
...
def audit(text: str) -> dict:
    ...
    if actual != expected or any(row['fp8_wmma_sites'] < 1 for row in rows
            ...
            any(row['global_store_b8_sites'] < 1 or row['global_store_b16_sites'] != 0
    ...
    return {
        ...
        'all_standard_qkv_pack_kernels_publish_software_e4m3_bytes': True,
