#!/usr/bin/env python3
"""Strictly ingest the RTX low-perturbation r944 packed-F16 path trace."""
...
try:
    ...
    from analyze_postblock_f16x2_path_trace import analyze_bytes
    from instrument_postblock_f16x2_path_trace import TRACE_BYTES


EXPECTED_REVISION = "v1_postblock_exact_frame1_selected_cta_f16x2_r944_path_trace"
...
def process(archive: Path, output: Path, amd_trace: Path) -> dict:
    ...
    checks = {
        ...
        "experiment": manifest.get("experiment") ==
            "rtx_postblock_exact_frame1_selected_cta_f16x2_r944_path_trace",
    ...
    (output / "comparison.json").write_text(json.dumps(comparison, indent=2) + "\n",
                                               encoding="utf-8")
    receipt = {
        "schema": 1, "experiment": "postblock_f16x2_r944_path_trace_result_ingestion",
        "status": "PASS", "classification": "POSTBLOCK_F16X2_R944_PATH_ORACLE_ACCEPTED",
...
def main() -> int:
    ...
    parser.add_argument("--amd-trace", type=Path,
                        default=Path("results/20260904_820000_postblock_exact_f16x2_path_trace/amd_trace.raw"))
