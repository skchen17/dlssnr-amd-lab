...
$result = Join-Path $root "_slot3_mma_trace_reference_result_$stamp"
...
$arguments = @(
    '--nvcuda',$nvcuda,
    '--ptx',(Join-Path $payload 'slot3_mma_trace.ptx'),
    ...
    '--n1-arena-param-view','64:27807744',
...
$checkpoint = Join-Path $result 'mma_trace.raw'
...
[ordered]@{
    ...
    classification = 'RTX_INTERNAL_FP8_MMA_NUMERICAL_ORACLE'
    counts_as_s7 = $false
